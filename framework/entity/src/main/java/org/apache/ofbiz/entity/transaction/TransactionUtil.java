...
public final class TransactionUtil implements Status {
    ...
    public static final Map<Xid, DebugXaResource> debugResMap = Collections.<Xid, DebugXaResource>synchronizedMap(new HashMap<>());
    ...
    private static void pushTransactionBeginStackSave(Exception e) {
        ...
        if (Debug.infoOn()) {
            ...
            allThreadsTransactionBeginStackSave.computeIfAbsent(curThreadId, k -> new LinkedList<>()).add(0, e);
        }
    }
