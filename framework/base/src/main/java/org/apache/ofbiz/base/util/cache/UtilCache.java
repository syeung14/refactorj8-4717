...
import org.apache.ofbiz.base.util.collections.google.ConcurrentLinkedHashMap;
import org.apache.ofbiz.base.util.collections.google.ConcurrentLinkedHashMap.Builder;
import org.apache.ofbiz.base.util.collections.google.EvictionListener;
...
public class UtilCache<K, V> implements Serializable, EvictionListener<Object, CacheLine<V>> {
    ...
    public long getSizeInBytes() {
        // REFACTOR: Replace with stream(), map(), sum().  Added bonus: use only method references without writing new methods
        long totalSize = 0;
        for (CacheLine<V> line: memoryTable.values()) {
