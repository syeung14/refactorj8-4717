...
final class StartupControlPanel {
    ...
    private static void loadStartupLoaders(Config config,
        ...
        synchronized (loaders) {
            ...
            try {
                Class<? extends StartupLoader> loaderClass = classloader.loadClass(startupLoaderName).asSubclass(StartupLoader.class);
                StartupLoader loader = loaderClass.getConstructor().newInstance();
